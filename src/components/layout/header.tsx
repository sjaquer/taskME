...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass h-16 px-4 flex items-center justify-between border-b border-white/5">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-xl font-headline font-bold tracking-tight bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
          TaskMe
        </h1>
      </div>
