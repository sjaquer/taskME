...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "mt-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:space-x-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/85 pt-3 pb-1",
      className
    )}
    {...props}
  />
