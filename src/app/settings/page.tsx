...
export default function SettingsPage() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      toast({ variant: "destructive", title: "Acción Denegada", description: "Re-autenticación necesaria." });
    }
  };
    ...
    <div className="space-y-8 max-w-4xl mx-auto py-4 px-2 md:px-0">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-center gap-6 md:gap-8">
        ...
        <div className="flex-1 space-y-3 text-center md:text-left w-full">
          <div className="space-y-1">
            ...
            <p className="text-[8px] text-muted-foreground font-black uppercase tracking-[0.4em] flex items-center justify-center md:justify-start gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label className="text-[8px] uppercase font-black text-primary">Nombre</Label>
            ...
            <div className="space-y-1.5">
              <Label className="text-[8px] uppercase font-black text-white/20">Enlace</Label>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section className="space-y-3">
          <h3 className="text-[8px] uppercase font-black text-muted-foreground tracking-[0.3em] flex items-center gap-2">
            ...
            <Dialog>
              ...
              <DialogContent className="glass-card border-white/10 bg-black/95">
                ...
                <div className="space-y-4 py-4">
                  <div className="space-y-1.5">
                    <Label className="text-[8px] uppercase font-black">Nueva Contraseña</Label>
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-[8px] uppercase font-black">Confirmar</Label>
  ...
  return (
    <div className="flex items-center justify-between group">
      <div className="space-y-0.5">
        ...
        <p className="text-[8px] text-muted-foreground uppercase">{active ? "En línea" : "Desconectado"}</p>
      </div>
