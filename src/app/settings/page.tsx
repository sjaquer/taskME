              ...
              <div className="flex gap-2">
                ...
                {isEmailUser && (
                  <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
                    ...
                    <DialogContent className="glass-card-elevated border-white/[0.08] bg-[#050505]/95 sm:max-w-[420px] p-6 sm:p-5 md:p-8">
        ...
        <div className="glass-card p-5 border border-red-500/10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
              ...
              <DialogContent className="glass-card-elevated border-red-500/20 bg-[#050505]/95 sm:max-w-[420px] p-6 sm:p-5 md:p-8">
